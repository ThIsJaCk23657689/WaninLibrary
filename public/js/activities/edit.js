...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    activityEditForm: function activityEditForm(e) {
      ...
      var content = CKEDITOR.instances.content.getData(); // console.log($(e.target)[0]);
                  ...
                  _c("div", { staticClass: "form-group" }, [
                    ...
                    _c(
                      "select",
                      {
                        ...
                        domProps: { value: _vm.activity.type }
                      },
                      [
...
var app = new Vue({
  ...
  created: function created() {
    ...
    axios.get(ActivitiesGetOneURL).then(function (response) {
      ...
      _this.content = response.data.activity.content; // console.log('sss:' + this.content);
