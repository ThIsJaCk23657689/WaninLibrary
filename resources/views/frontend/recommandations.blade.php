...
@push('CustomJS')
	<script src="{{ asset('js/frontend/recommandations/index.js') }}" defer></script>
@endpush

@push('CustomCSS')
    <link href="{{  asset('css/frontend/recommandations/index.css') }}" rel="stylesheet" type="text/css">
@endpush

@section('content')
<div id="content-recommandations">
    ...
    <section class="content-page-body">
        <div class="container">
            ...
            <recommandation-container :recommandations="recommandations"></recommandation-container>
