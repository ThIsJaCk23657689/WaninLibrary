            ...
            <form method="POST" id="activity_edit_form" enctype="multipart/form-data" action="#" @submit.prevent="activityEditForm">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        <upload-images ref="uploadCoverImages" :uploadimg="ActivitiesCoverImageURL" :title="'上傳封面圖片'" :aspect-ratio="6/5.8" :prefix="'activity'" :helptext="'（建議尺寸：600px * 580px）'"></upload-images>
                    </div>
                </div>
